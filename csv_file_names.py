...
def create_csv(connector):
    ...
    home = ["1", "Home", "https://gcallah.github.io/NYCOpenDocs/index.html", "", "glyphicon-home"]
    ...
    for file in file_names:
        ...
        if isinstance(file, str):
            ...
            output_lst[URL] = "https://gcallah.github.io/NYCOpenDocs/html/" + file.strip(".") + ".html"
        ...
        # returned from check directories
            ...
            while index_dif < len(file):
                ...
                if index_dif == len(file) - 1:
                    output_lst[URL] = "https://gcallah.github.io/NYCOpenDocs/html/" + "_".join(file) + ".html"
                    ...
                    output_dir_lst[URL] = "https://gcallah.github.io/NYCOpenDocs/html/" + "_".join(file[:index_dif + 1]) + "_" + file[index_dif] + ".html"
                    out_dir = True
